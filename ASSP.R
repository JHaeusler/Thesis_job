...
Matriz_General_ASSP <- Matriz_Resultados %>%  mutate( dif_rel = 1 - (n_opt/n_clasico), 
                                                      dif_RAP = (RAP_t_clasico - RAP_t_opt))
write.csv(Matriz_General_ASSP, "Matriz_Resultados.csv", row.names = FALSE)
